...
<div class="content-wrapper">
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Product Category Lists</li>
    </ol>
    <?php 
  ...
  <!-- Example DataTables Card-->
    <div class="card mb-3">
      <div class="card-header">
        <i class="fa fa-table"></i>Product Category Lists
        <?php
            if($userPermission['add']){
              ?>
        <a style="float:right;" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>admin/product/category-add"><i class="fa fa-plus"></i> Add New Category </a> 
        <?php
          }
          ?>
        </div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          ...
          <select name="" id="multiple_type" class="service_category_multiple_type multi_select" data-action="product/delete-active-inactive-multiple-category">
        ...
        <?php
          ...
          <tr>
            ...
            if($userPermission['edit']){
              ?>
                    <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/product/product-category-edit/'.$sList['categoryId']; ?>" title="Edit"><i class="fa fa-pencil"></i></a>
                    <?php
            }
            if($userPermission['delete']){
            ?>

                    <a class="btn btn-sm btn-danger deleteRow deleteBlog" href="javascript:void(0);" data-delete-href="<?php echo base_url().'admin/product/product-category-delete/'.$sList['categoryId']; ?>" data-type="blog" title="Delete"><i class="fa fa-trash"></i></a>
                    <?php }
            ?>    
                </td>
              </tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="deleteModalLabel">Are you sure want to delete this product category</h4>
      </div>
