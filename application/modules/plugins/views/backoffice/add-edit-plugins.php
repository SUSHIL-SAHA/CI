      ...
      <div class="col-md-12">
        ...
        <div class="box box-primary">
          <div class="header_box version_2">
            ...
            <a class="btn btn-primary btn-sm pull-right" href="<?php echo base_url();?>admin/plugins"><i class="fa fa-level-up"></i> Back to list</a>
          </div><!-- /.box-header -->
          <!-- form start -->
          <br clear="all">
          <?php $this->load->helper("form"); ?>
          <form role="form" id="AddEditPluginformId" action="<?php echo base_url(); ?>admin/plugins/insert-plugin" method="post" role="form" enctype="multipart/form-data">
          <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>" />
            ...
            <div class="box-footer">
              ...
              <input type="button" onclick="location.href='<?php echo base_url();?>admin/plugins';" class="btn btn-default" value="Cancel" />
