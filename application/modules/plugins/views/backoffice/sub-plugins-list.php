  ...
  <div class="container-fluid">
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item">
        <a href="<?php echo base_url();?>admin/plugins">Plugins</a>
      </li>
      <li class="breadcrumb-item active"><?php echo $plugins_details['module_name'];?></li>
    </ol>
    <?php 
      ...
      <div class="card-header">
        ...
        <?php
            if($userPermission['add']){
              ?>
          <a style="float:right;" class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>admin/plugins/create-sub-plugin/<?php echo $plugins_details['module_id'];?>"><i class="fa fa-plus"></i> Create Plugin</a>
          <?php
          }
          ?>
      ...
      <div class="card-body">
        <div class="table-responsive">
          ...
          <tbody>
              <?php
              //print_r($cat_lists);
              if(!empty($sub_plugins)){
                $i=0;
                foreach($sub_plugins as $row){
                  $i++;
                ?>
              ...
              <td><input type="checkbox" id="check" name="check" value="<?php echo $row['module_id']; ?>"></td>
                <td><?php echo $i;?></td>
                <td><a href="<?php echo base_url();?>admin/plugins/edit-sub-plugin/<?php echo $row['module_id'] ; ?>"><?php echo $row['module_name'];?></a></td>
          ...
          <div class="bottom-select">
            <select name="" id="multiple_type" class="inner_banner_multiple_type multi_select" data-action="sub-plugins/delete-active-inactive-multiple-sub-plugins">
