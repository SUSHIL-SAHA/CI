...
$config['sess_cookie_name'] = 'ci_session_skeleton_ci';
...
if(!is_dir($config['sess_save_path'])) @mkdir($config['sess_save_path'], 0777, true); 
...
$config['csrf_exclude_uris'] = array(
  'admin/banner/delete-active-inactive-multiple-banner',
  'admin/banner/delete-active-inactive-multiple-inner-banner',
  'admin/service/delete-active-inactive-multiple-service',
  'admin/service/delete-active-inactive-multiple-category',
  'admin/cms/delete-active-inactive-multiple-page',
  'admin/seo/updatehomedefault',
  'admin/seo/multiple-delete-active-inactive',
  'admin/cms/deleteCmsImage',
  'paypal_ipn',
  'paypal_success'
);
...
if (is_dir($module_folder)){
  if ($dh = opendir($module_folder)){
    while (($module = readdir($dh)) !== false){
      if($module != '.' && $module != '..' )
      {
        $routes_path = $module_folder.$module.'/config/config.php';
